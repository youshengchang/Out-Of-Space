...
- (void)viewDidLoad
{
    ...
    NSArray *spaceObjectAsPropertLists = [[NSUserDefaults standardUserDefaults]arrayForKey:ADDED_SPACE_OBJECTS_KEY];
    for(NSDictionary *dictionary in spaceObjectAsPropertLists){
        ITISpaceObject *spaceObject = [self spaceObjectForDictionary:dictionary];
...
-(void)addSpaceObject:(ITISpaceObject *)newSpaceObject
{
    ...
    [spaceObjectsAsPropertyLists addObject:[self spaceObjectAsPropertyList:newSpaceObject]];
...
-(NSDictionary *)spaceObjectAsPropertyList:(ITISpaceObject *)spaceObject
{
...
-(ITISpaceObject *)spaceObjectForDictionary:(NSDictionary *)dictionary
{
    NSData *dataForImage = dictionary[PLANET_IMAGE];
    UIImage *spaceObjectImage = [UIImage imageWithData:dataForImage];
    
    ITISpaceObject *spaceObject = [[ITISpaceObject alloc]initWithData:dictionary andImage:spaceObjectImage];
    return spaceObject;
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        for(ITISpaceObject *spaceObject in self.addedSpaceObjects){
